...
local_css("D:/Streamlit/style/style.css")


lottie_coding = load_lottieurl("https://lottie.host/d0e56ed4-f238-4a13-97de-531bd19ebcbf/nINxWXnlPW.json")

with st.container():
    st.header("If Have a Problem, Contact Us Below!")
    st.write("##")

    contact_form = """
    <form action="https://formsubmit.co/sultantohandecha@gmail.com" method="POST">
