...
#footer
# Function to get top 20 recommended books based on highest ratings
st.markdown(f'<span style="color:black; font-size:28px; display: block;margin: 22px;"><b>Top 20 Recommended books</b></span>',  unsafe_allow_html=True)
def top_20_books():
    top_books = final_rating.sort_values(by='rating', ascending=False).head(20)
    return top_books

# Display the top 20 books
if st.sidebar.button('Show Top 20 Books'):
    st.sidebar.write("Top 20 Books Based on Highest Ratings:")
