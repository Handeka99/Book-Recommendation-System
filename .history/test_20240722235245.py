...
if options == 'Top 20 Books':
    ...
    if st.button('Get Recommendations'):
        if method == 'NormalPredictor':
            recommendations = get_recommendation(npred, user_id)
        elif method == 'KNN':
            recommendations = get_recommendation(knn, user_id)
        elif method == 'SVD':
            recommendations = get_recommendation(svd, user_id)
        elif method == 'SVD++':
            recommendations = get_recommendation(svdpp, user_id)
